...
public class DefaultGlobalExceptionHandlerAdviceTest {
    ...
    public void testDuplicateKeyException() {
        Result result = defaultGlobalExceptionHandlerAdvice.duplicateKeyException(new DuplicateKeyException("主键重复"));
    ...
    public void testException() {
        Result result = defaultGlobalExceptionHandlerAdvice.exception(new RuntimeException("error"));
        assertEquals(SystemErrorType.SYSTEM_ERROR.getCode(), result.getCode());
    }

    @Test
    public void testThrowable() {
        Result result = defaultGlobalExceptionHandlerAdvice.throwable(new RuntimeException("error"));
        assertEquals(SystemErrorType.SYSTEM_ERROR.getCode(), result.getCode());
    }
}